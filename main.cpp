...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (mainProcess.show_setting) {
            ...
            if (ImGui::Begin("Settings", &mainProcess.show_setting)) {
        ...
        if (mainProcess.gui_status) {
            ...
            if (ImGui::Begin("GUI Status", &mainProcess.gui_status)) {
        ...
        if (mainProcess.start_processing) {
            ...
            if (mainProcess.display_live) {
                if (ImGui::Begin("Live Event", &mainProcess.display_live)) {
                ...
                if (ImGui::Begin("Pre-processed Events", &mainProcess.display_live)) {
