...
int main(int, char**)
{
    ...
    static std::string rec_path = "/Path/To/Images";
    static bool display_rec = true;
    static bool gui_status = true;
    static int frame = 1;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (display_rec) {
            ...
            ImGui::Begin("Folder Images", &display_rec);
            ...
            if (rec_path.empty()) {
                ...
                cv::Mat image = cv::imread(rec_path + std::to_string(frame) + ".jpg", cv::IMREAD_COLOR);
